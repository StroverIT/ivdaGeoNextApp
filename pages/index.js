          ...
          <div className="container h-full">
            <div className="justify-between lg:flex ">
              <section className="flex flex-col items-center justify-center w-full p-3 sm:flex-row sm:justify-start bg-green custom-border">
                ...
                <div className="w-full mt-2 text-center text-white sm:mt-0 sm:ml-4 lg:text-left">
              ...
              <div className="flex items-center justify-center w-full">
                <div className="flex justify-end w-full">
                  <input
                    type="text"
                    className="w-full px-4 py-2 border lg:w-64 border-gray"
                    placeholder="Вашият и-мейл"
                  />
                  <button
                    type="button"
                    className="px-4 text-white transition-colors w-52 bg-primary hover:bg-primary-trans"
                  >
                    Абонирай ме
                  </button>
                </div>
            ...
            <div className="my-5 text-sm text-center">
              С абонамента се съгласявате предоставените от Вас лични данни да
              бъдат обработвани за целите и по начина посочени в общите условия,
              включително, но не само, за да получавате информация за актуални
              промоции и други активности на ИвдаГео.
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <section className="items-center justify-center grid-cols-2 my-5 md:grid">
              <div className="my-5 text-center md:text-left lg:ml-40 md:my-0">
                ...
                асортимент от продукти на отлични цени и качествено обслужване.
                През годините се доказахме като надежден и лоялен партньор в
                бранша. Ние следим всички нови тенденции и можем да ви предложим
                решение за всеки индивидуален проект.
              </div>
