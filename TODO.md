...
Да е с разстояние Ивда Гео
Еконт да е с главна буква

Да е с поръчай, а не към завършване
Да пише отдолу безплатна доставка над 300 лв.
И да са един под друг продуктите - като masterhaus
Да се избира литраж или да се избира цвятс и да е със име на производител
Да се показва информацищ в и-мейла на продуктите.
Преди да се направи поръчка да е цъкнал, че се сълкгасява с общите условия и че е сългасен с тях
Поръчката трябва да се вземе в рамките на 3 дни.
Потвърдете тук.
И да се махне потвърждаването на поръчката
С QR да се изпраща поръчката към админ панела по id да я търси
Да има снимката и като се цъкне да показва всички на производител
Примерно на интериорни бои като се цъкне и да ги показва всичките
