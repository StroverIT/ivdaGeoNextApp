...
To show the name and the email when user is logged in [x]
When delivery is created to write: "{full name}, успешно направихте поръчка в Ivda Geo Paint - online" [x]
