...
<li className="mb-4">
<a href="#" className="hover:underline">Доставка</a>
</li>
<li className="mb-4">
<a href="#" className="hover:underline">Как да пазарувам</a>
</li>

</ul>
</div>
<div>
<h2 className="mb-6 text-sm font-semibold text-gray-400 uppercase">Контакти и Помощ</h2>
<ul className="text-gray-300">
<li className="mb-4">
<a href="#" className="hover:underline">Помощ</a>
</li>
<li className="mb-4">
<a href="#" className="hover:underline">Контакти</a>
</li>
<li className="mb-4">
<a href="#" className="hover:underline">Общи условия
</a></li><a href="#" className="hover:underline">
</a><li className="mb-4"><a href="#" className="hover:underline">
</a><a href="#" className="hover:underline">Политика за поверителност</a>
</li>
</ul>
</div>
<div>
...
<div className="py-6 bg-gray-700 md:flex md:items-center md:justify-between">
<div className="text-sm text-gray-300 text-center">© 2022 <a href="/contact">IvdaGeo™</a>. Всички права запазени.
</div>
